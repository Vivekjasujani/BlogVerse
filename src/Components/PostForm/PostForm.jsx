            ...
            <div className="w-full lg:w-2/3 px-2">
                ...
                <div className='mt-4'>
                    <Input 
                        label="Author :"
                        placeholder="Author"
                        className="mb-4 border border-gray-600 text-white rounded-lg bg-black bg-opacity-80 focus:bg-opacity-90 focus:outline focus:ring-none cursor-not-allowed"
                        {...register("author")}
                        disabled
                    />
                </div>
